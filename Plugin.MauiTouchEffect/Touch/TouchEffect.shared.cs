...
#pragma warning restore SA1000 // Keywords should be spaced correctly
    ...
    ////				_ = new Plugin.MauiTouchEffect.Android.Effects.PlatformTouchEffect();
    ////#elif __IOS__
    ////			if (System.DateTime.Now.Ticks < 0)
    ////				_ = new Plugin.MauiTouchEffect.iOS.Effects.PlatformTouchEffect();
    ////#elif __MACOS__
    ////			if (System.DateTime.Now.Ticks < 0)
    ////				_ = new Plugin.MauiTouchEffect.macOS.Effects.PlatformTouchEffect();
    ////#elif TIZEN
    ////			if (System.DateTime.Now.Ticks < 0)
    ////				_ = new Plugin.MauiTouchEffect.Tizen.Effects.PlatformTouchEffect();
    ////#elif UWP
    ////			if (System.DateTime.Now.Ticks < 0)
    ////				_ = new Plugin.MauiTouchEffect.UWP.Effects.PlatformTouchEffect();
    ////#endif
    ////			#endregion
    //		}
