...
using Plugin.MauiTouchEffect.Helpers;
...
namespace Test1
{
    public class Class1
    {
        ...
        {
            return Android.Resource.Attribute.SelectableItemBackground;
        }
    }
}
...
namespace Plugin.MauiTouchEffect.Effects
{
    public class PlatformTouchEffect : Microsoft.Maui.Controls.Platform.PlatformEffect
    {
        ...
        protected override void OnAttached()
        {
            ...
            View.Context?.Theme?.ResolveAttribute(Test1.Class1.GetTest(), outValue, true);

            //var d = view.Context.Resources.GetDrawable(outValue.ResourceId); //Causes purple foreground
            var drawableFromTheme = View.Context?.Resources?
                .GetDrawable(outValue.ResourceId, View.Context.Theme);
            //drawableFromTheme.SetTint(Color.Red);
            View.Foreground = drawableFromTheme;
            //View.Background = drawableFromTheme;

            //var id = View.Context?.Resources?.GetIdentifier("android:attr/selectableItemBackground", null, null);
            //
